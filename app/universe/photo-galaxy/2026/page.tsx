...
const memories = [
  {
    month: "January",
    title: "A New Dawn",
    src: "/images/photo-galaxy/2026/january.jpg",
    caption: "A softer sky, a brighter future.",
  },
  {
    month: "February",
    title: "Another Orbit",
    src: "/images/photo-galaxy/2026/february.jpg",
    caption: "Still choosing the same planet.",
  },
  {
    month: "June",
    title: "One Year Loading",
    src: "/images/photo-galaxy/2026/june.jpg",
    caption: "One year. One universe. Us.",
  },
];

export default function Galaxy2026Page() {
  return (
      ...
      >
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl font-serif text-xl italic text-white/75">
            Another orbit around SDS-23, and a future still unfolding.
          </p>
        </div>
